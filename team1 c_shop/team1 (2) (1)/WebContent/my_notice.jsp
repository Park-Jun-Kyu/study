...
<html>
		...
		<header>
			...
			<nav>
				...
				<ul>
					...
					<li>COOKIT메뉴</li>
					<li>리뷰</li>
					<li><a href="PEventCommand.do">이벤트</a></li>
					<li>MY쿡킷</li>
				</ul>
				<ul>
	...
	<section>
		...
		<c:if test="${page>1 }">
		<a href="my_notice.do?opt=${opt }&search=${search }&page=${page-1 }"><strong>◀ </strong></a>
		</c:if>
		...
		<c:when test="${a != page }">
			<a href="my_notice.do?opt=${opt }&search=${search }&page=${a }"><strong>${a }</strong></a>
		</c:when>
