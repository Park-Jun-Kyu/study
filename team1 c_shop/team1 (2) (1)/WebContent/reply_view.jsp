...
<html>
	...
	<body>
	<form action="reply.do" name="form" method="get">
		<header>
			<div id="nav_up">
				<ul>
					<li>회원가입</li>
	...
	<section>
	 ...
	 <input type="hidden" name="pId" value="${reply_view.pId }">
      ...
      <input type="hidden" name="pIndent" value= "${reply_view.pIndent }">
		<input type="text" id="txt" name="pTitle" value="${reply_view.pTitle }" placeholder="문의할 주문번호 또는 상품을 선택해주세요.">
					</div>
		...
		<button type="submit" id="btn_green"><span>확인</span></button>
		</div>
