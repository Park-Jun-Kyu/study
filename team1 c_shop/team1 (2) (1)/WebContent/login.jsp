...
<body>
	...
	<form action="login.do" method="post">
		<div id="login">
			...
			<div id=input>
				<input type="text" class="inputInfo" name="mId" value=""
					placeholder="CJONE 통합아이디 6~20자 "> <input type="text"
					class="inputInfo" name="mPw" value=""
				...
				<input type="submit" id="loginbutton">로그인
			</div>
			<div></div>
			<div id=loginSub>
