...
<html>
	...
	<section>
		...
		<div id="top">	
			<h2>${my_notice2.pId }</h2>
			<h2>${my_notice2.pTitle }</h2>
			<span>${my_notice2.pDate }</span>
		...
		<a href="my_notice.do">
			...
			<a href="delete.do?pId=${my_notice2.pId}">
			<div id="art">
				<span>삭제</span>
			
			</div></a>
			
			<a href="modify_view.do?pId=${my_notice2.pId }">
			<div id="art">
				<span>수정</span>
				
			
			</div></a>
			<a href="reply_view.do?pId=${my_notice2.pId }"> 
			<div id="art">
				<span>답글달기</span>
