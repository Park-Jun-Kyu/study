			...
			<section id="container">
				<div id="content" class="ev_content">
					<div class="ev_wrap">
						...
						<div class="view">
							<div class="head">
							<input type="hidden" name="eId" value="${event_contentView.eId }">
							<input type="hidden" name="eName" value="${event_contentView.eName }">
							<input type="hidden" name="eHit" value="${event_contentView.eHit }">
							<input type="hidden" name="eDate" value="${event_contentView.eDate }">
							
								<h2 class="tit" >
								<input type="hidden" name="eTitle" value="${event_contentView.eTitle }">
									${event_contentView.eTitle }
									<span class="date">2020-03-13 ~ 2020-03-31</span>
								</h2>
							...
							<div class="conts">
								<div>
									<input type="hidden" name="eFile" value="${event_contentView.eFile }">
									<img src="${ pageContext.request.contextPath}/upload/${event_contentView.eFile }">
								</div>
							</div>
