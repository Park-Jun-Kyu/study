...
<body>
	...
	<div id="big">
		...
		<br>
			...
			<h2>이벤트</h2>
			<br>
			<form id="form1"  name="inputform" action="PEventCommand.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="eName" value="${adminEventWrite.eName }">
          <label class="input_label">제목 작성</label>
          <input class="btitle" type="text" name="eTitle">
        <div class="input_set">
          <div class="input_1">
        ...
        <div class="bttn_set">
          <button onclick="location.href='moreList.do'">취소</button>
