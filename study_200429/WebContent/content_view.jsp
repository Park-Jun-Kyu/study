...
<body>
  ...
  <section>
    ...
    <table>
      ...
      <tr>
        <th colsapn="3">${content_view.pTitle }</th>
      </tr>
       <tr>
        <th colsapn="3">$<strong>${content_view.pId }//${content_view.pName }</strong></th>
      </tr>
      
      <tr>
        <td>${content_view.pDate }</td>
        <td>조회수</td>
        <td>${content_view.pHit }</td>
      </tr>
      <tr>
        <td colspan="3" class="article">${content_view.pContent }</td>
      </tr>
      <tr>
    ...
    <a href="delete.do?pId=${content_view.pId }"><div class="list">삭제</div></a>
    <a href="modify_view.do?pId=${content_view.pId }"> <div class="list">수정</div></a>
    <a href="reply_view.do?pId=${content_view.pId }"> <div class="list">답변달기</div></a>
  </section>
